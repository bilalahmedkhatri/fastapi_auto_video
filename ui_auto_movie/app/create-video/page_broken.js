...
const ProcessingModal = ({ isVisible, videoId, taskId, onClose }) => {
...
export default function CreateVideo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Add to global progress sidebar instead of modal
      addGlobalProcess({
      ...
      alert('Video creation started! You can track progress in the sidebar.');
