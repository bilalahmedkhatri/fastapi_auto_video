  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "absolute h-5 w-5 rounded-full border-2 border-blue-600 dark:border-blue-500 bg-white dark:bg-gray-800 shadow transition-colors hover:bg-gray-50 dark:hover:bg-gray-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:pointer-events-none",
            disabled && "border-gray-400 dark:border-gray-500"
          )}
          style={{
